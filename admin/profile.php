						...
						<div class="col-md-10 col-md-push-1">
		                    <div class="panel panel-default" style="margin-top:20px;">
		                        <div class="panel-heading">
		                            <div class="panel-title"><a class="mess-me">Tin nhắn riêng</a></div>
		                        </div>
		                        <div class="panel-body pre-scrollable">
			                        <div class="row">
			                        	<div class="col-md-9">
			                        		<div ><a href="" class="title-set">Tài khoản 1</a></div>
			                        	</div>
			                        	<div class="col-md-3">Cách đây 2 giờ</div>
			                        </div>
			                        <div class="row">
			                        	<div class="col-md-9">
			                        		hadjahdj
						...
						<div class="col-md-10 col-md-push-1">
		                    <div class="panel panel-default" style="margin-top:20px;">
		                        ...
		                        <div class="panel-body pre-scrollable">
			                        <div class="row">
			                        	<div class="col-md-9">
			                        		<div ><a href="" class="title-set">Bạn đã bình luận trong một Chủ đề</a></div>
			                        	</div>
			                        	<div class="col-md-3">Cách đây 2 giờ</div>
			                        </div>
			                        <div class="row">
			                        ...
			                        <div class="row">
			                        	<div class="col-md-9">
			                        		<div ><a href="" class="title-set">Admin thêm bài đăng mới</a></div>
			                        	</div>
			                        	<div class="col-md-3">Cách đây 2 giờ</div>
			                        </div>
			                        <div class="row">
			                        ...
			                        <div class="row">
			                        	<div class="col-md-9">
			                        		<div ><a href="" class="title-set">Thông báo về tài khoản của bạn</a></div>
			                        	</div>
			                        	<div class="col-md-3">Cách đây 2 giờ</div>
			                        </div>
			                        <div class="row">
			                        ...
			                        <div class="row">
			                        	<div class="col-md-9">
			                        		<div ><a href="" class="title-set">Bình luận mới từ Chủ đề bạn quan tâm</a></div>
			                        	</div>
			                        	<div class="col-md-3">Cách đây 2 giờ</div>
			                        </div>
			                        <div class="row">
