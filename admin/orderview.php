                                    ...
                                    <?php
                                        ...
                                        if (strpos($str,"topic")==true) {
                                            ...
                                            if (strpos($str,"topic.php")==true){
                                                ...
                                                $sql = "SELECT * FROM article, topic, user WHERE ((article.iduser=user.iduser) AND (article.idtopic=topic.idtopic) AND (article.state = '1') AND (article.idtopic = '$strtopic')) ORDER BY countview DESC";
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="dropdown-toggle" data-toggle="dropdown" style="">
                                                            <?php
                                                                ...
                                                                $sql1 = "SELECT * FROM topic WHERE ((state='1') AND (idtopic !='1') AND (idtopic != '$strtopic'))";
                                                ...
                                                $sql = "SELECT * FROM article, topic, user WHERE ((article.iduser=user.iduser) AND (article.idtopic=topic.idtopic) AND (article.state = '1'))  ORDER BY countview DESC";
                                                $result = mysqli_query($con, $sql);
                                                ?>
                                                ...
                                                <div class="row" style="border-bottom: 1px solid #ddd;">
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            ...
                                                            <?php
                                                                // include("control/configure.php");
                                                                $sql1 = "SELECT * FROM topic WHERE ((state='1') AND (idtopic !='1'))";
                                                                $result1 = mysqli_query($con, $sql1);
                                                                while($row1=mysqli_fetch_array($result1)){
                                                                    echo "<li><a href='topic.php?idtopic={$row1['idtopic']}'><span class='glyphicon glyphicon-stop' style='color:{$row1['color']};'></span> ".$row1['nametopic']."</a></li>";
                                                                }
                                            ...
                                            if (strpos($str,"search.php")==true){
                                               // lay do dai url
                                                $dai1=strlen($str);
                                                // lay do dai chuoi tu vi tri cuoi cung den vi tri tu khoa
                                                // $dai2=strlen("&btnTim=btnTim");
                                                // lay vi tri dau '=''
                                                $kitu = strpos($str,"=");
                                                // lay chuoi trong $str tu vi tri dau tien den vi tri cua dau '='' +1
                                                $strstart=substr($str,0, $kitu+1);
                                                // lay do dai cua chuoi da lay tu vi tri dau tien den vi tri cua dau '='' +1
                                                $dai3=strlen($strstart);
                                                // lay do dai cua tu khoa
                                                $dodai=$dai1-$dai3;
                                                // lay ra tu khoa
                                                $strsearch = substr($str, $kitu+1, $dodai);
                                                // decode tu khoa
                                                $x = urldecode($strsearch);
                                                    $sql = "SELECT * FROM article, user, topic WHERE ((article.iduser=user.iduser) AND (article.idtopic=topic.idtopic) AND (article.state = '1') AND ((namearticle LIKE '%$x%') OR (fullname LIKE '%$x%') OR (article.content LIKE '%$x%'))) ORDER BY countview DESC";
                                                    $result = mysqli_query($con, $sql);
                                                ...
                                                $sql = "SELECT * FROM article, topic, user WHERE ((article.iduser=user.iduser) AND (article.idtopic=topic.idtopic) AND (article.state = '1')) ORDER BY countview DESC LIMIT 20";
                                                $result = mysqli_query($con, $sql);
