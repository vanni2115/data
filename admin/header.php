        ...
        <div class="collapse navbar-collapse" id="menu-navbar">
            <ul class="nav navbar-nav navbar-right">
                <li class="animated wow fadeInLeftBig" data-wow-delay="900ms">
                    <form class="navbar-form navbar-left" style="margin-right:0;margin-left:0;margin-bottom:0;" action="search.php" method="GET">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="letter-my" style="" name="search" value="Nhập từ khóa..." onfocus="if (this.value == 'Nhập từ khóa...') {this.value = ''}" onblur="if (this.value == '') {this.value = 'Nhập từ khóa...';}">
                                <span class="input-group-btn">
                                    <button type="submit" class="btn btn-letter-my">Tìm kiếm</button>
                                </span>
                            </div><!-- /input-group -->
                        </div>
                    </form>
                ...
                <li class="animated wow fadeInLeftBig" data-wow-duration="1200ms" data-wow-delay="800ms">
                    ...
                    <ul class="dropdown-menu" id="ava-ul" style="background:url('images/bgtop.jpg');">
                        <?php
                            if(($_SESSION['role']=="2")) {
                        ?>
                        <li><a href="pages/article.php"><i class="glyphicon glyphicon-lock"></i> Trang quản trị</a></li>
                        <?php
                            }
                        ?>
