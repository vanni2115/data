                                    ...
                                    <?php
                                        ...
                                        if (strpos($str,"topic")==true) {
                                            ...
                                            if (strpos($str,"topic.php")==true){
                                                ...
                                                $sql = "SELECT * FROM article, topic, user WHERE ((article.iduser=user.iduser) AND (article.idtopic=topic.idtopic) AND (article.state = '1') AND (article.idtopic = '$strtopic')) ORDER BY datepost DESC";
                                                ...
                                                $sql = "SELECT * FROM article, topic, user WHERE ((article.iduser=user.iduser) AND (article.idtopic=topic.idtopic) AND (article.state = '1'))  ORDER BY datepost DESC";
                                                $result = mysqli_query($con, $sql);
                                                ?>
                                            ...
                                            if (strpos($str,"search.php")==true){
                                                ...
                                                $x = urldecode($strsearch);
                                                    $sql = "SELECT * FROM article, user, topic WHERE ((article.iduser=user.iduser) AND (article.idtopic=topic.idtopic) AND (article.state = '1') AND ((namearticle LIKE '%$x%') OR (fullname LIKE '%$x%') OR (article.content LIKE '%$x%'))) ORDER BY datepost DESC";
                                                    $result = mysqli_query($con, $sql);
                                                    ?>
                                                    ...
                                                    while($row=mysqli_fetch_array($result)){
                                                        ...
                                                        $html = str_get_html($small)->plaintext;
                                                        $rutgon = words($html, 30);
                                                        // echo str_replace("%$x%", "<strong>{%$x%}</strong>", $rutgon);
                                                        // echo substr_replace('%$x%', '<strong>%$x%</strong>', 0);
                                                        echo "<div class='row' style='border-bottom:dashed 1px #d2d2d2;margin:20px 50px;'>
                                                        <div class='col-md-7'>
                                                            <div id='tieude_tintuc'>
                                                                <a href='article.php?idtopic={$row['idtopic']}&idarticle={$row['idarticle']}'>" .$row['namearticle']. "</a>
                                                ...
                                                $sql = "SELECT * FROM article, topic, user WHERE ((article.iduser=user.iduser) AND (article.idtopic=topic.idtopic) AND (article.state = '1'))  ORDER BY datepost DESC LIMIT 20";
                                                $result = mysqli_query($con, $sql);
