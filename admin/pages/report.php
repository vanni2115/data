...
<?php
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Báo cáo vi phạm</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="mytable">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM noti WHERE idarticle = 0";
                                            ...
                                            echo "<tr class='odd gradeX'>
                                                ...
                                                <td>
                                                    <div class='pull-right action-buttons'>
                                                        <a href='delete-noti.php?idnoti={$row['idnoti']}' name='btnDel' value='del' class='trash'><span class='glyphicon glyphicon-trash' style='color:rgb(209, 91, 71)'></span></a>
                                                    </div>
                                                </td>
                                            </tr>";
                                        }
