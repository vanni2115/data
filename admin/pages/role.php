...
<?php
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Quản lý phân quyền</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                        ...
                                        echo "<tr class='odd gradeX'>
                                                ...
                                                <td>
                                                    <div class='pull-right action-buttons'>
                                                        <a href='edit-role.php?idrole={$row['idrole']}' name='btnChange' value='change'><span class='glyphicon glyphicon-pencil'></span></a>
