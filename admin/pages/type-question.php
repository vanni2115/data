...
<head>
    ...
    <title>Quản lý dạng câu hỏi</title>
...
<?php
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Quản lý dạng câu hỏi</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        echo "<tr class='odd gradeX'>
                                                <td>".$row['idtypequestion']."</td>
                                                <td>".$row['nametype']."</td>
                                                <td>
                                                    <div class='pull-right action-buttons'>
                                                        <a href='edit-type-question.php?idtypequestion={$row['idtypequestion']}' name='btnChange' value='change'><span class='glyphicon glyphicon-pencil'></span></a>
