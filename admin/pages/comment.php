                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="mytable">
                                <thead>
                                    <tr>
                                        <th>Nội dung</th>
                                        <th>Tên thành viên bình luận</th>
                                        <th>Tên bài biết</th>
                                        <th>Tùy chỉnh</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM comment,article,user WHERE ((article.idarticle=comment.idarticle) AND comment.iduser=user.iduser)";
                                        $result = mysqli_query($con, $sql);
                                        $num_rows = mysqli_num_rows($result);
                                        while($row=mysqli_fetch_array($result)){
                                        echo "<tr class='odd gradeX'>
                                                <td><textarea class='col-md-12 pre-scrollable' style='height:50px;'>".$row['contentcomment']."</textarea></td>
                                                <td>".$row['fullname']."</td>
                                                <td>".$row['namearticle']."</td>
                                                <td>
                                                    <div class='pull-right action-buttons'>
                                                        <a href='edit-comment.php?idcomment={$row['idcomment']}' name='btnChange' value='change'><span class='glyphicon glyphicon-pencil'></span></a>
