                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="mytable">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM question,typequestion WHERE question.idtype=typequestion.idtypequestion";
                                        $result = mysqli_query($con, $sql);
                                        $num_rows = mysqli_num_rows($result);
                                        while($row=mysqli_fetch_array($result)){
                                        echo "<tr class='odd gradeX'>
                                                <td><textarea class='col-md-12 pre-scrollable' style='height:50px;'>".$row['content']."</textarea></td>
                                                <td>".$row['nametype']."</td>
                                                <td>".$row['daa']."</td>
                                                <td>".$row['dab']."</td>
                                                <td>".$row['dac']."</td>
