...
<?php
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Dạng bài tập</h1><div id='noti-action'></div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-md-10 col-md-push-1">
                                    <form id="change" name="regis" method="POST" onSubmit="javascript:return validate();">
                                        <div class="form-group row">
                                            <label for="nametype" class="col-md-3 control-label">Tên dạng bài tập mới</label>
                                            <div class="col-md-9">
                                                <input class="form-control" type="text" name="nametype" id="nametype">
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-pop center-block" value="add-topic" name="btnAdd" id="btnAdd"><b>Thêm</b></button>
                                    </form>
                                    <?php
                                        include( "../control/configure.php");
                                        if (isset($_REQUEST['btnAdd'])&&isset($_REQUEST['nametype'])) {
                                            $nametype=$_REQUEST['nametype'];
                                            $sql="INSERT INTO exam(nameexam) VALUES ('{$nametype}')";
