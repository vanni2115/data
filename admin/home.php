            ...
            <div class="midle_main_idclass fix1200_cus1">
                <div class="banner-bottom animated wow lightSpeedIn" data-wow-duration="1500ms" data-wow-delay="800ms">
                    <ul id="flexiselDemo1">
                        ...
                        unset($sql,$result,$row,$small,$html,$rutgon);
                        mysqli_close($con);
                        ?>
                ...
                <div class="midle_main_idclass">
                    <div class="products">
                        <div class="container_new container_child">
                            ...
                            <div class="row">
                                <h4 style='font-size: 32px;color: #4a4a4a;margin: 0 auto 35px;text-align: center;text-transform: uppercase;font-weight: 500;'>Các bài thảo luận</h4>
                                ...
                                <div class="clearfix"></div>
                                <div class='more' style="text-align:center;margin-top:20px;"> <a href='topics.php'>Xem thêm</a> </div>
                            </div>
                        </div>
                    </div>
