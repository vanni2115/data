<nav class="navbar-inverse navbar-fixed-top" role="navigation" style="font-size:16px;background:url('images/bgtop.jpg') no-repeat 0px 0px;">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="menu-navbar">
                <ul class="nav navbar-nav navbar-right">
                    <li class="animated wow fadeInLeftBig" data-wow-duration="1200ms" data-wow-delay="900ms">
                        <form class="navbar-form navbar-left" role="search" style="margin-right:0;margin-left:0;margin-bottom:0;" action="search.php" method="GET">
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="search" placeholder="Gõ nội dung tìm kiếm...">
                                    <span class="input-group-btn">
                                        <button type="submit" class="btn btn-default" name="btnTim" value="btnTim">Tìm kiếm</button>
                                    </span>
                                </div><!-- /input-group -->
                            </div>
                        </form>
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    ?>
                    <li class="animated wow fadeInLeftBig" data-wow-duration="1200ms" data-wow-delay="900ms"><a href="" data-toggle="modal" data-target="#myModal-res"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Đăng ký</a></li>
                    <li class="animated wow fadeInLeftBig" data-wow-duration="1200ms" data-wow-delay="1000ms"><a href="" data-toggle="modal" data-target="#myModal-log"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span> Đăng nhập</a></li>
                    <?php 
                        }
                    ?>
